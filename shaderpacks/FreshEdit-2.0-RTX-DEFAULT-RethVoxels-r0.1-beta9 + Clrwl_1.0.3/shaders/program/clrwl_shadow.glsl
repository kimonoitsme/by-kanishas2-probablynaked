...
void main() {
    if (passType == 0) {
        ...
        color1.rgb = mix(color1.rgb, overlayColor.rgb, overlayColor.a);
        ...
        clrwl_computeFragment(col, col, lmcoord, ao, overlayColor);
        col.rgb = mix(col.rgb, overlayColor.rgb, overlayColor.a);
